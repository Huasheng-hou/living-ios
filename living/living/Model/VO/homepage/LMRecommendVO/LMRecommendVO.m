...
+ (LMRecommendVO *)LMRecommendVOWithJSONString:(NSString *)jsonString usingEncoding:(NSStringEncoding)stringEncoding error:(NSError **)error
{
    ...
    if (nil != error && nil != jsonDictionary) {
        return [LMRecommendVO LMRecommendVOWithDictionary:jsonDictionary];
    }
...
{
    LMRecommendVO *instance = [[LMRecommendVO alloc] initWithDictionary:dictionary];
...
+ (NSArray *)LMRecommendVOListWithArray:(NSArray *)array
{
    ...
    for (id entry in array) {
        ...
        [resultsArray addObject:[LMRecommendVO LMRecommendVOWithDictionary:entry]];
    }
