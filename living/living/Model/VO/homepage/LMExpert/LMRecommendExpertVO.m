...
@implementation LMRecommendExpertVO
+ (LMRecommendExpertVO *)LMRecommendExpertVOWithJSONString:(NSString *)jsonString usingEncoding:(NSStringEncoding)stringEncoding error:(NSError **)error
{
    ...
    if (nil != error && nil != jsonDictionary) {
        return [LMRecommendExpertVO LMRecommendExpertVOWithDictionary:jsonDictionary];
    }
...
{
    LMRecommendExpertVO *instance = [[LMRecommendExpertVO alloc] initWithDictionary:dictionary];
...
+ (NSArray *)LMRecommendExpertVOListWithArray:(NSArray *)array
{
    ...
    for (id entry in array) {
        ...
        [resultsArray addObject:[LMRecommendExpertVO LMRecommendExpertVOWithDictionary:entry]];
    }
