...
NSString *const kArticleBodyFakeid = @"uuid";
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        self.fakaid = [[self objectOrNilForKey:kArticleBodyFakeid fromDictionary:dict] doubleValue];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSNumber numberWithDouble:self.fakaid] forKey:kArticleBodyFakeid];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.fakaid = [aDecoder decodeDoubleForKey:kArticleBodyFakeid];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeDouble:_fakaid forKey:kArticleBodyFakeid];
