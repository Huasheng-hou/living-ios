...
@implementation LMEventCommentVO
...
+ (LMEventCommentVO *)LMEventCommentVOWithJSONString:(NSString *)jsonString usingEncoding:(NSStringEncoding)stringEncoding error:(NSError **)error
{
    ...
    if (nil != error && nil != jsonDictionary) {
        return [LMEventCommentVO LMEventCommentVOWithDictionary:jsonDictionary];
    }
...
{
    LMEventCommentVO *instance = [[LMEventCommentVO alloc] initWithDictionary:dictionary];
...
+ (NSArray *)LMEventCommentVOListWithArray:(NSArray *)array
{
    ...
    for (id entry in array) {
        ...
        [resultsArray addObject:[LMEventCommentVO LMEventCommentVOWithDictionary:entry]];
    }
