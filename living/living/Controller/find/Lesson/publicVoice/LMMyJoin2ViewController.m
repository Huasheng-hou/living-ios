...
@implementation LMMyJoin2ViewController
...
{
    LMMyJoinFinishVoiceRequest    *request    = [[LMMyJoinFinishVoiceRequest alloc] initWithPageIndex:self.current andPageSize:20];
